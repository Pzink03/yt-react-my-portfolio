...
const About = () => {
  return (
    <div name="about" className='w-auto h-auto bg-gradient-to-b from-gray-800 to-black text-white p-4'>
        <div className='max-w-screen-lg pt-4 mx-auto flex flex-col justify-center w-auto h-auto'>
            <div className='pb-2 pt-20'>

                <p className='text-4xl font-bold inline border-b-4 m border-gray-500'>About</p>
