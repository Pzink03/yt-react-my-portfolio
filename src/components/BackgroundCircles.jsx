...
const homeIcons = [
  {
    ...
    imageClassName:
      "w-8 h-8 rounded-full mt-9 -rotate-[36deg] shadow-[0_0_10px_3px] shadow-color-softBlue",
    rotate: 34,
    y: -50,
    delay: 0.6,
    duration: 0.8,
  },
  {
    ...
    duration: 0.8,
    imageClassName:
      "w-8 h-8 rounded-full mt-2 rotate-[36deg] shadow-[0_0_10px_3px] shadow-color-softBlue",
  },
  {
    id: 3,
    src: react,
    ...
    duration: 0.8,
    imageClassName:
      "w-8 h-8 rounded-full rotate-[65deg] -mt-2 shadow-[0_0_10px_3px] shadow-color-softBlue",
  },
  {
    id: 4,
    src: tailwind,
    ...
    duration: 0.8,
    imageClassName:
      "w-8 h-8 rounded-full rotate-[70deg] -mt-12 shadow-[0_0_10px_3px] shadow-color-softBlue",
  },
  {
    id: 5,
    src: css,
    ...
    duration: 0.8,
    imageClassName:
      "w-8 h-8 rounded-full mt-7 -rotate-[65deg] shadow-[0_0_10px_3px] shadow-color-softBlue",
  },
  {
    id: 6,
    src: html,
    ...
    duration: 0.8,
    imageClassName:
      "w-8 h-8 rounded-full mt-2 -rotate-[95deg] shadow-[0_0_10px_3px]  shadow-color-softBlue",
  },
  {
    id: 7,
    src: github,
    ...
    duration: 0.8,
    imageClassName:
      "w-8 h-8 rounded-full -ml-4 -rotate-[40deg] shadow-[0_0_10px_3px]  shadow-color-softBlue",
  },
  {
    id: 8,
    src: django,
    className:
      "absolute bottom-1/2 mr-4 right-[55.5%] w-14 h-1/3 origin-bottom",
    rotate: -34,
    y: -50,
    delay: 1.1,
    duration: 0.8,
    imageClassName:
      "w-8 h-8 rounded-full mt-4 rotate-[34deg] shadow-[0_0_10px_3px]  shadow-color-softBlue",
  },
  {
    id: 9,
    src: postgresql,
    ...
    duration: 0.8,
    imageClassName:
      "w-8 h-8 rounded-full mt-2 rotate-[4deg] shadow-[0_0_10px_3px]  shadow-color-softBlue",
  },
]
    ...
    <div className="absolute -top-[42.375rem] left-1/2 w-[78rem] aspect-square border border-gray-900 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:top-[5.5rem]">
      ...
      {homeIcons.map((icon) => (
        <motion.div
          ...
          key={icon.id}
        >
          <img src={icon.src} className={icon.imageClassName} alt="icons" />
        </motion.div>
      ))}
    </div>
  )
